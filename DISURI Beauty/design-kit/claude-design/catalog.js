...
window.BUNDLES = [
  ...
  },
  {
    ...
    subtitle: 'Smooth + Hydrate',
    eyebrow: 'Beginner-friendly · 2-Step Glass Skin',
    family: 'bundle',
    ...
    benefit: 'Your first step into glass skin — a simple 2-step duo for smoother, clearer, deeply hydrated skin.',
    benefitEs: 'Tu primer paso hacia el glass skin: un dúo sencillo de 2 pasos para una piel más suave, uniforme e hidratada.',
    description: 'Pairs our snail mucin cream with our hyaluronic acid cream for a beginner-friendly path to smooth, hydrated, light-reflective skin. Two creams, one ritual you can actually keep — the glass-skin base everything else builds on.',
    badges: [
      {
        label: 'Save $7.50',
        tone: 'crimson',
    ...
    conditions: [
      ...
      'First K-beauty routine',
      'Glass-skin glow goals',
    ],
    ...
    usage: [
      ...
      'Ultimate Snail Mucin Cream (smooths + calms)',
      'HA Intense Hydration Cream (deep hydration + lock-in)',
      'Use daily for minimum 4 weeks for best results',
      'Add Triple-Collagen-Firming-Toner when ready for step three (optional)',
    ],
    compliance: 'Supports the appearance of smoother, more hydrated, light-reflective skin with continued use. Patch test before broader use.',
  },
];
